        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            @foreach ($employees as $employee)
                <div class="relative bg-white p-4 rounded-lg shadow-md">
                    <div class="absolute top-0 right-0 mt-2 mr-2 z-50 rounded-full overflow-hidden border-2 border-white">
                        <img src="{{ $employee->productImage }}" alt="{{ $employee->productName }}" class="w-24 h-24 md:w-32 md:h-32 object-cover" />
                    </div>
