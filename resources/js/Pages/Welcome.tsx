...
export default function Welcome({
  ...
  return (
    <>
      <Head title="Welcome" />
      <div className="min-h-screen flex justify-center items-center bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        <div className="sm:fixed sm:top-0 sm:right-0 p-6 text-start">
          {auth.user ? (
            <Link
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <ImageHolder
            ...
            className="watch-image watch-image__one"
          />
          <ImageHolder
            img={currentScene.image2}
            className="watch-image watch-image__two"
          />
          <ImageHolder
            img={currentScene.image3}
            className="watch-image watch-image__three"
          />
        </div>
      </div>
